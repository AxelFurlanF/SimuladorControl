...
public class CLI {
	...
	public static void main(String[] args) throws UnirestException {
		...
		System.out.println("Bienvenido, ingrese el id del user");
		System.out.println("Id:");
		Integer id_user = Integer.parseInt(scanner.nextLine());
		...
		*/
		...
		String url = "equipo3-app.us-east-2.elasticbeanstalk.com:9000";
		...
		while(in) {
		    ...
		    switch (choice) {
		        case 1:
		    		GetRequest jsonResponse = Unirest.get("http://"+url+"/api/dispositivos/"+id_user);
		        ...
		        case 2:
		    		...
		    		GetRequest statusResponse = Unirest.get("http://"+url+"/api/apagar_dispositivo/" + id_user + "/" +id_dispo);
		        ...
		        case 3:
		    		...
		    		GetRequest statusResponse_e = Unirest.get("http://"+url+"/api/encender_dispositivo/" + id_user + "/" +id_dispo_e);
		        ...
		        case 4:
		    		...
		    		GetRequest statusResponse_a = Unirest.get("http://"+url+"/api/ahorro_dispositivo/" + id_user + "/" +id_dispo_a);
		    		System.out.println(statusResponse_a.asString().getBody());
		        	break;
		        case 5:
		        	System.out.println("Que dispositivo desea poner en modo de ahorro? ID:");
		    		GetRequest statusResponse_c = Unirest.get("http://"+url+"/api/consumo_ultimo_mes/" + id_user);
